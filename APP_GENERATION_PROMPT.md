# AI Prompt for App Generation & Project Snapshot

This document contains a complete snapshot of the project's configuration, including the high-level AI prompt, all library versions, and the Gradle build settings from the last successful build.
...
-   **Android Gradle Plugin:** Use version 8.13.0.
-   **KSP:** Use KSP (version 2.3.2) instead of Kapt for annotation processing.
-   **compileSdk:** 36
-   **targetSdk:** 36
-   **minSdk:** 28
...
## 2. Detailed Configuration Snapshot
...
### Root Gradle Settings (`build.gradle.kts`)
...
### App-Level Gradle Settings (`app/build.gradle.kts`)
